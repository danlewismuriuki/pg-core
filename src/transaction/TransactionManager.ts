...
// //     // ✅ CORRECT: Get ALL currently active transactions
// //     const currentlyActive = Array.from(this.activeTxns.keys());
    
// //     // ✅ CORRECT: xmin is the oldest active transaction
// //     // If no other active transactions, use current txnId as baseline
// //     const xmin = 
// //       currentlyActive.length === 0 
// //         ? txnId 
// //         : Math.min(...currentlyActive);
    
// //     const snapshot: Snapshot = {
// //       xmin,
// //       xmax: this.nextTxnId, // ✅ CORRECT: Use the ALREADY INCREMENTED nextTxnId
// //       activeTxns: new Set(currentlyActive), // ✅ CORRECT: All active excluding self
// //       myTxnId: txnId,
// //     };
    
// //     const txn = new Transaction(txnId, snapshot);
// //     this.activeTxns.set(txnId, txn); // Add self AFTER snapshot
...
//       xmin,
//       xmax: this.nextTxnId,
//       activeTxns: new Set(currentlyActive), 
//       myTxnId: txnId,
//     };
...
export class TransactionManager {
  ...
  begin(): Transaction {
    ...
    // Get ALL currently active transactions (EXCLUDING the new one)
    const currentlyActive = Array.from(this.activeTxns.keys());
    ...
    const snapshot: Snapshot = {
      xmin,
      xmax: this.nextTxnId, // ✅ CORRECT: Use the ALREADY INCREMENTED nextTxnId
      activeTxns: new Set(currentlyActive), // All active EXCLUDING self
      myTxnId: txnId,
    };
