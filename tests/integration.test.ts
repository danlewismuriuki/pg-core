...
//     const t2 = db.begin();
//     const results = db.select(t2);

//     expect(results.length).toBe(0);

//     db.commit(t1);

//     const results2 = db.select(t2);
...
//     // After all transactions commit, old versions should be GC'd
//     // Manual verification through logs
//   });
...
//     const results = db.select(t3, ['user_1']);
//     expect(results.length).toBe(1);

//     db.commit(t2);

//     const results2 = db.select(t3, ['user_1']);
